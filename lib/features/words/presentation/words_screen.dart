      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _ExerciseCard(
              emoji: '🔠',
              titulo: 'Primera Letra',
              subtitulo: 'Escucha la palabra y elige su letra inicial',
              color: AppTheme.wordsColor.withValues(alpha: 0.45),
              onTap: () => context.push('/words/first-letter'),
            ),
            const SizedBox(height: 16),
            _ExerciseCard(
              emoji: '🔢',
              titulo: 'Sílabas',
              subtitulo: 'Escucha la palabra y cuenta sus sílabas',
              color: AppTheme.wordsColor.withValues(alpha: 0.3),
              onTap: () => context.push('/words/syllable-count'),
            ),
            const SizedBox(height: 16),
            _ExerciseCard(
              emoji: '🎵',
              titulo: '¿Riman?',
              subtitulo: 'Escucha dos palabras y decide si riman',
              color: AppTheme.wordsColor.withValues(alpha: 0.2),
              onTap: () => context.push('/words/rhyme-check'),
            ),
            const SizedBox(height: 16),
            _ExerciseCard(
              emoji: '🧩',
              titulo: 'Construir palabras',
              subtitulo: 'Ordena las sílabas para formar la palabra',
              color: AppTheme.wordsColor.withValues(alpha: 0.12),
              onTap: () => context.push('/words/syllable-build'),
            ),
          ],
        ),
      ),
